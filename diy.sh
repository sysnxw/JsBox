...
my_scripts_list_4="jd_entertainment.js jd_shake.js jd_marketLottery.js jd_xmf.js jd_wish.js jd_lenovo.js jd_oneplus.js jd_mother_jump.js"

## 活动脚本名称1：东东爱消除、个护爱消除
## 活动脚本名称2：京喜工厂Plus
## 活动脚本名称3：京东泡泡大战
## 活动脚本名称4：百变大咖秀、超级摇一摇、京东超市-大转盘、众筹许愿池、科技打造品质生活、一加盲盒、母婴跳一跳
